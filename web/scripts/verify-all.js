...
const checks = [
  ...
  { name: 'render-query-budget', file: 'smoke-render-query-budget.js', estSec: 2, expectExit: 0 },
  { name: 'culture-raster-performance', file: 'smoke-culture-raster-performance.js', estSec: 2, expectExit: 0 },
  { name: 'minimap-idle-render', file: 'smoke-minimap-idle-render.js', estSec: 2, expectExit: 0 },
  { name: 'battle-hud-retained', file: 'smoke-battle-hud-retained.js', estSec: 2, expectExit: 0 },
  { name: 'raster-display-cache', file: 'smoke-raster-display-cache.mjs', estSec: 2, expectExit: 0 },
  { name: 'render-performance-r2', file: 'smoke-render-performance-r2.mjs', estSec: 2, expectExit: 0 },
  { name: 'imperial-tax-policy', file: 'smoke-imperial-tax-policy.mjs', estSec: 2, expectExit: 0 },
  ...
  { name: 'save-finite-validation', file: 'smoke-save-finite-validation.js', estSec: 2, expectExit: 0 },
  { name: 'save-project-text-bridge', file: 'smoke-save-project-text-bridge.js', estSec: 1, expectExit: 0 },
  { name: 'save-map-aliases', file: 'smoke-save-map-aliases.js', estSec: 1, expectExit: 0 },
  ...
  { name: 'roster-audience-reference', file: 'smoke-roster-audience-reference.mjs', estSec: 2, expectExit: 0 },
  ...
  { name: 'turn-response-recovery', file: 'smoke-turn-response-recovery.js', estSec: 3, expectExit: 0 },
  { name: 'turn-recovery-quality', file: 'smoke-turn-recovery-quality.js', estSec: 3, expectExit: 0 },
  { name: 'save-commit-boundary', file: 'smoke-save-commit-boundary.js', estSec: 3, expectExit: 0 },
  { name: 'snapshot-deadlines', file: 'smoke-snapshot-deadlines.js', estSec: 3, expectExit: 0 },
  { name: 'storage-read-deadlines', file: 'smoke-storage-read-deadlines.js', estSec: 3, expectExit: 0 },
  { name: 'storage-write-reliability', file: 'smoke-storage-write-reliability.js', estSec: 3, expectExit: 0 },
  ...
  { name: 'desktop-autosave-reliability', file: 'smoke-desktop-autosave-reliability.js', estSec: 3, expectExit: 0 },
  { name: 'recovery-vault', file: 'smoke-recovery-vault.js', estSec: 3, expectExit: 0 },
  { name: 'final-save-reconcile', file: 'smoke-final-save-reconcile.js', estSec: 3, expectExit: 0 },
  { name: 'memory-scoring-equivalence', file: 'smoke-memory-scoring-equivalence.js', estSec: 3, expectExit: 0 },
  { name: 'final-recovery-races', file: 'smoke-final-recovery-races.js', estSec: 3, expectExit: 0 },
  { name: 'api-wait-compatibility', file: 'smoke-api-wait-compatibility.js', estSec: 3, expectExit: 0 },
  { name: 'player-writeback-regressions', file: 'smoke-player-writeback-regressions.js', estSec: 3, expectExit: 0 },
  { name: 'player-state-regressions', file: 'smoke-player-state-regressions.js', estSec: 3, expectExit: 0 },
  { name: 'player-text-memory-regressions', file: 'smoke-player-text-memory-regressions.js', estSec: 3, expectExit: 0 },
  { name: 'launch-reentry', file: 'smoke-launch-reentry.js', estSec: 3, expectExit: 0 },
  { name: 'turn-runtime-cycle-boundary', file: 'smoke-turn-runtime-cycle-boundary.js', estSec: 3, expectExit: 0 },
