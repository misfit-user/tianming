// ═══ 巨石拆分(20260706)：corruption 引擎核心·家族首片(原 A) ═══
// 随行 sibling 须紧接装载：tm-corruption-cases.js → tm-corruption-extras.js。 装载序契约见 lint-split-contracts。原 tm-corruption-engine.js 2490 行·R9 三 IIFE 合并已倒回三片。
// @ts-check
