...
(function(){
  ...
  var TOPBAR_REDESIGN_CSS = [
    ...
    'body.tm-phase8-formal #topbar .tb-dyn{font:calc(23 * var(--tm-px, 1px))/1.05 "Ma Shan Zheng","STKaiti","KaiTi",serif!important;background:linear-gradient(135deg,#f6eccf,#e7c97c 50%,#b8924e)!important;-webkit-background-clip:text!important;background-clip:text!important;-webkit-text-fill-color:transparent!important;}',
    'body.tm-phase8-formal #topbar .tb-ruler{font:calc(11 * var(--tm-px, 1px))/1.2 "ZCOOL XiaoWei","STKaiti",serif!important;color:#8f8568!important;letter-spacing:.05em!important;max-width:128px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;}',
    ...
    'body.tm-phase8-formal #topbar .tb-time-main{max-width:none!important;font:calc(19 * var(--tm-px, 1px))/1.15 "Ma Shan Zheng","STKaiti","KaiTi",serif!important;color:#f0ead8!important;letter-spacing:.02em!important;white-space:nowrap!important;}',
    'body.tm-phase8-formal #topbar .tb-time-sub{max-width:none!important;margin-top:2px!important;font:calc(11 * var(--tm-px, 1px))/1.2 "ZCOOL XiaoWei",serif!important;color:#9a9072!important;letter-spacing:.03em!important;}',
    ...
    'body.tm-phase8-formal #topbar .tb-var.wide .tb-vn{display:block!important;flex:none!important;max-width:none!important;padding:0!important;font:calc(11 * var(--tm-px, 1px))/1 "ZCOOL XiaoWei",serif!important;color:#c2a463!important;letter-spacing:.1em!important;text-align:left!important;}',
    ...
    'body.tm-phase8-formal #topbar .tb-var.wide .sv b{display:block!important;font:600 calc(14 * var(--tm-px, 1px))/1.15 "Ma Shan Zheng","STSong","SimSun",serif!important;color:#f4ede0!important;}',
    'body.tm-phase8-formal #topbar .tb-var.wide .sv .sd{display:block!important;font:calc(10 * var(--tm-px, 1px))/1 "ZCOOL XiaoWei",serif!important;margin-top:1px!important;}',
    ...
    'body.tm-phase8-formal #topbar .tb-var:not(.wide) .tb-vn{display:block!important;font:calc(11 * var(--tm-px, 1px))/1.2 "ZCOOL XiaoWei",serif!important;color:#7d6c49!important;letter-spacing:.06em!important;}',
    'body.tm-phase8-formal #topbar .tb-var:not(.wide) .tb-vv{font:calc(13 * var(--tm-px, 1px))/1.15 "Ma Shan Zheng","STSong",serif!important;color:#cdb06a!important;}',
    ...
    'body.tm-phase8-formal #topbar .tb-seal-idx .tsi-ch{font:calc(18 * var(--tm-px, 1px))/1 "Ma Shan Zheng","STSong","SimSun",serif!important;color:#d8bd78!important;}',
    'body.tm-phase8-formal #topbar .tb-seal-idx .tsi-val{font:calc(10 * var(--tm-px, 1px))/1 "ZCOOL XiaoWei",serif!important;color:#b6a06a!important;letter-spacing:.02em!important;}',
    ...
    'body.tm-phase8-formal #topbar .tb-vding{font:calc(11 * var(--tm-px, 1px))/1 "Songti SC","STSong","SimSun",serif!important;color:#9a8a66!important;margin-top:3px!important;font-variant-numeric:tabular-nums!important;}',
    ...
    'body.tm-phase8-formal #topbar.tm-tb-fit2 .tb-dyn{font-size:calc(19 * var(--tm-px, 1px))!important;}',
    'body.tm-phase8-formal #topbar.tm-tb-fit2 .tb-time-main{font-size:calc(16 * var(--tm-px, 1px))!important;}',
    'body.tm-phase8-formal #topbar.tm-tb-fit2 .tb-ruler{max-width:88px!important;}',
    'body.tm-phase8-formal #topbar.tm-tb-fit2 .tb-var.wide .sv b{font-size:calc(12.5 * var(--tm-px, 1px))!important;}',
    'body.tm-phase8-formal #topbar.tm-tb-fit2 .tb-var.wide .tb-vn{font-size:calc(9.5 * var(--tm-px, 1px))!important;letter-spacing:.04em!important;}',
    ...
    'body.tm-phase8-formal #topbar.tm-tb-fit2 .tb-var:not(.wide) .tb-vv{font-size:calc(12 * var(--tm-px, 1px))!important;}',
    'body.tm-phase8-formal #topbar.tm-tb-fit2 .tb-var:not(.wide) .tb-vn{font-size:calc(10 * var(--tm-px, 1px))!important;}',
    'body.tm-phase8-formal #topbar.tm-tb-fit2 .tb-var.tb-seal-idx{min-width:33px!important;padding:0 3px!important;}',
    'body.tm-phase8-formal #topbar.tm-tb-fit2 .tb-seal-idx .tsi-ch{font-size:calc(15 * var(--tm-px, 1px))!important;}',
    'body.tm-phase8-formal #topbar.tm-tb-fit2 .tb-seal-idx .tsi-val{font-size:calc(9 * var(--tm-px, 1px))!important;}',
  ...
  function installRightIssueStyles(){
    ...
    st.textContent = [
      ...
      'body.tm-phase8-formal .tmrp-stat b{color:#f2d98d;font-size:calc(20 * var(--tm-px, 1px));line-height:1;font-variant-numeric:tabular-nums;letter-spacing:.02em;white-space:nowrap;text-shadow:0 1px 4px rgba(0,0,0,.5);}body.tm-phase8-formal .tmrp-stat span{margin-top:7px;color:rgba(232,220,187,.52);font-size:calc(12 * var(--tm-px, 1px));letter-spacing:.12em;}',
      ...
      'body.tm-phase8-formal .tmrp-person{width:100%;display:grid;grid-template-columns:34px minmax(0,1fr) 42px;align-items:center;gap:8px;text-align:left;border:1px solid rgba(201,168,95,.16);background:rgba(0,0,0,.18);color:#eadfbd;padding:7px;cursor:pointer;font-family:inherit;}body.tm-phase8-formal .tmrp-person.active{border-color:rgba(213,103,73,.50);background:linear-gradient(90deg,rgba(114,45,31,.42),rgba(0,0,0,.16));}body.tm-phase8-formal .tmrp-person b{display:block;color:#f2d98d;font-size:calc(13 * var(--tm-px, 1px));white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-person span span{display:block;margin-top:2px;color:rgba(232,220,187,.52);font-size:calc(11.5 * var(--tm-px, 1px));white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-person small{color:rgba(141,189,171,.86);font-size:calc(11 * var(--tm-px, 1px));text-align:right;}',
      'body.tm-phase8-formal .tmrp-avatar{width:30px;height:30px;border-radius:50%;display:grid;place-items:center;border:1px solid rgba(201,168,95,.34);background:radial-gradient(circle at 35% 24%,rgba(255,229,153,.25),rgba(73,43,20,.80));color:#f2d98d;font-size:calc(13 * var(--tm-px, 1px));overflow:hidden;}body.tm-phase8-formal .tmrp-avatar img{width:100%;height:100%;object-fit:cover;display:block;}',
      ...
      'body.tm-phase8-formal .tmrp-wd-rules{display:grid;gap:6px;}body.tm-phase8-formal .tmrp-wd-rules div:not(.tmrp-card-title){display:grid;grid-template-columns:68px minmax(0,1fr);gap:8px;border:1px solid rgba(201,168,95,.12);background:rgba(0,0,0,.12);padding:6px 8px;}body.tm-phase8-formal .tmrp-wd-rules b{color:#f2d98d;font-size:calc(12 * var(--tm-px, 1px));font-weight:500;}body.tm-phase8-formal .tmrp-wd-rules span{color:rgba(232,220,187,.62);font-size:calc(12 * var(--tm-px, 1px));line-height:1.45;}body.tm-phase8-formal .tmrp-wd-rules>summary{list-style:none;cursor:pointer;display:flex;align-items:baseline;justify-content:space-between;gap:8px;}body.tm-phase8-formal .tmrp-wd-rules>summary::-webkit-details-marker{display:none;}body.tm-phase8-formal .tmrp-wd-rules>summary span{color:#f2d98d;font-size:calc(13 * var(--tm-px, 1px));letter-spacing:.14em;}body.tm-phase8-formal .tmrp-wd-rules>summary span:before{content:"\\203B";margin-right:7px;color:rgba(213,103,73,.78);font-size:calc(12 * var(--tm-px, 1px));}body.tm-phase8-formal .tmrp-wd-rules>summary small{color:rgba(232,220,187,.46);font-size:calc(11 * var(--tm-px, 1px));letter-spacing:.02em;}body.tm-phase8-formal .tmrp-wd-rules[open]>summary{margin-bottom:2px;}body.tm-phase8-formal .tmrp-issue-foot{text-align:center;opacity:.78;font-size:calc(11.5 * var(--tm-px, 1px));letter-spacing:.06em;}',
      ...
      'body.tm-phase8-formal .tmrp-wd-person .tmrp-avatar{grid-row:1/3;}body.tm-phase8-formal .tmrp-wd-person .main{min-width:0;}body.tm-phase8-formal .tmrp-wd-person b{display:block;color:#f2d98d;font-size:calc(13 * var(--tm-px, 1px));white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-wd-person b i{font-style:normal;color:#d56b55;margin-left:3px;}body.tm-phase8-formal .tmrp-wd-person small{display:block;color:rgba(232,220,187,.50);font-size:calc(11 * var(--tm-px, 1px));margin-top:2px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-wd-person .meta{grid-column:2;display:flex;gap:4px;flex-wrap:wrap;}body.tm-phase8-formal .tmrp-wd-person .meta em{font-style:normal;border:1px solid rgba(201,168,95,.14);background:rgba(201,168,95,.05);color:#d8c27c;font-size:calc(11 * var(--tm-px, 1px));line-height:1;padding:3px 5px;}',
      'body.tm-phase8-formal .tmrp-wd-request{display:grid;grid-template-columns:minmax(0,1fr) 46px;gap:6px;align-items:stretch;border:1px solid rgba(201,168,95,.16);background:rgba(0,0,0,.16);padding:6px;}body.tm-phase8-formal .tmrp-wd-request.envoy{border-color:rgba(141,189,171,.28);}body.tm-phase8-formal .tmrp-wd-request-main{min-width:0;display:grid;grid-template-columns:42px minmax(0,1fr);gap:8px;align-items:center;text-align:left;border:0;background:transparent;color:#eadfbd;font-family:inherit;padding:0;cursor:pointer;}body.tm-phase8-formal .tmrp-wd-request-main b{display:block;color:#f2d98d;font-size:calc(13 * var(--tm-px, 1px));white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-wd-request-main b i{font-style:normal;color:#8dbdab;margin-left:5px;font-size:calc(11 * var(--tm-px, 1px));}body.tm-phase8-formal .tmrp-wd-request-main small{display:block;color:rgba(232,220,187,.58);font-size:calc(12 * var(--tm-px, 1px));line-height:1.45;margin-top:2px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}',
      'body.tm-phase8-formal .tmrp-wd-mini{border:1px solid rgba(201,168,95,.20);background:rgba(18,13,10,.74);color:#e7d39e;font-family:inherit;font-size:calc(12 * var(--tm-px, 1px));cursor:pointer;}body.tm-phase8-formal .tmrp-wd-mini.danger{border-color:rgba(198,78,55,.30);color:#e7a38c;}',
      'body.tm-phase8-formal .tmrp-mini-grid,body.tm-phase8-formal .tmrp-rows{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px;}body.tm-phase8-formal .tmrp-mini-grid div,body.tm-phase8-formal .tmrp-rows div{border:1px solid rgba(201,168,95,.12);background:rgba(0,0,0,.12);padding:7px;min-width:0;}body.tm-phase8-formal .tmrp-mini-grid span,body.tm-phase8-formal .tmrp-rows span{display:block;color:rgba(232,220,187,.48);font-size:calc(11.5 * var(--tm-px, 1px));}body.tm-phase8-formal .tmrp-mini-grid b,body.tm-phase8-formal .tmrp-rows b{display:block;margin-top:3px;color:#eadfbd;font-size:calc(12 * var(--tm-px, 1px));font-weight:400;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
      'body.tm-phase8-formal .tmrp-meta{margin:7px 0;color:rgba(232,220,187,.66);font-size:calc(12 * var(--tm-px, 1px));line-height:1.65;}',
      'body.tm-phase8-formal .tmrp-social-head{cursor:pointer;}body.tm-phase8-formal .tmrp-social-head:hover{border-color:rgba(226,185,92,.42);background:linear-gradient(180deg,rgba(96,44,30,.34),rgba(0,0,0,.16));}body.tm-phase8-formal .tmrp-detail-hint{margin-top:8px;border-top:1px solid rgba(201,168,95,.12);padding-top:7px;color:rgba(141,189,171,.78);font-size:calc(12 * var(--tm-px, 1px));letter-spacing:.04em;}body.tm-phase8-formal .tm-social-detail-flyout{width:396px;}',
      'body.tm-phase8-formal .tmrp-social-cause{display:grid;gap:5px;margin:8px 0;padding:7px 8px;border:1px solid rgba(201,168,95,.12);background:rgba(0,0,0,.14);min-width:0;}body.tm-phase8-formal .tmrp-social-cause b{color:#f2d98d;font-size:calc(12 * var(--tm-px, 1px));font-weight:500;letter-spacing:.08em;}body.tm-phase8-formal .tmrp-social-cause span{display:block;color:rgba(232,220,187,.66);font-size:calc(12 * var(--tm-px, 1px));line-height:1.45;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-social-cause.empty span{color:rgba(232,220,187,.42);}',
      'body.tm-phase8-formal .tmrp-signal-cause .tmrp-cause-row{display:grid;grid-template-columns:auto minmax(0,1fr);gap:6px;align-items:center;}body.tm-phase8-formal .tmrp-signal-cause .tmrp-cause-source{color:#f2d98d;font-style:normal;font-size:calc(11.5 * var(--tm-px, 1px));white-space:nowrap;}body.tm-phase8-formal .tmrp-signal-cause small{min-width:0;color:rgba(232,220,187,.66);font-size:calc(12 * var(--tm-px, 1px));line-height:1.45;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
      'body.tm-phase8-formal .tmrp-ecology{display:grid;gap:6px;margin:8px 0;padding:7px 8px;border:1px solid rgba(141,189,171,.18);background:linear-gradient(180deg,rgba(141,189,171,.055),rgba(0,0,0,.14));min-width:0;}body.tm-phase8-formal .tmrp-ecology-head{display:flex;align-items:center;justify-content:space-between;gap:8px;}body.tm-phase8-formal .tmrp-ecology-head b{color:#f2d98d;font-size:calc(12 * var(--tm-px, 1px));font-weight:500;letter-spacing:.08em;}body.tm-phase8-formal .tmrp-ecology-head small{color:rgba(141,189,171,.72);font-size:calc(11 * var(--tm-px, 1px));}body.tm-phase8-formal .tmrp-ecology-list,body.tm-phase8-formal .tmrp-ecology-signals{display:grid;gap:5px;min-width:0;}body.tm-phase8-formal .tmrp-ecology-edge{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:3px 6px;border:1px solid rgba(201,168,95,.12);background:rgba(0,0,0,.16);padding:6px;min-width:0;}body.tm-phase8-formal .tmrp-ecology-edge.estranged{border-color:rgba(198,78,55,.26);box-shadow:inset 2px 0 rgba(198,78,55,.32);}body.tm-phase8-formal .tmrp-ecology-link{min-width:0;border:0;background:transparent;color:#ffe1ac;text-align:left;font-family:inherit;font-size:calc(11.5 * var(--tm-px, 1px));padding:0;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-ecology-edge span{color:rgba(141,189,171,.86);font-size:calc(11 * var(--tm-px, 1px));text-align:right;white-space:nowrap;}body.tm-phase8-formal .tmrp-ecology-edge small{grid-column:1/3;color:rgba(232,220,187,.64);font-size:calc(11.5 * var(--tm-px, 1px));white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-ecology-edge em{grid-column:1/3;color:rgba(232,220,187,.45);font-style:normal;font-size:calc(11 * var(--tm-px, 1px));white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-ecology-forecast{grid-column:1/3;color:rgba(232,220,187,.70);font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.45;border-left:2px solid rgba(141,189,171,.42);padding-left:6px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-ecology-signal{display:grid;grid-template-columns:auto minmax(0,1fr);gap:6px;align-items:center;color:rgba(232,220,187,.58);font-size:calc(11.5 * var(--tm-px, 1px));min-width:0;}body.tm-phase8-formal .tmrp-ecology-signal b{color:#d8c27c;font-weight:400;white-space:nowrap;}body.tm-phase8-formal .tmrp-ecology-signal span{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
      'body.tm-phase8-formal .tmrp-social-chain{display:flex;flex-wrap:wrap;gap:5px;margin:7px 0 2px;min-width:0;}body.tm-phase8-formal .tmrp-chain-step{max-width:100%;min-height:24px;border:1px solid rgba(201,168,95,.16);background:rgba(201,168,95,.055);color:rgba(232,220,187,.72);padding:3px 6px;font-family:inherit;font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.25;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-chain-step:hover{border-color:rgba(226,185,92,.42);background:rgba(126,45,32,.24);color:#ffe1ac;}',
      'body.tm-phase8-formal .tmrp-actor-action{display:grid;gap:5px;margin:8px 0;padding:7px 8px;border:1px solid rgba(141,189,171,.18);background:rgba(141,189,171,.055);min-width:0;}body.tm-phase8-formal .tmrp-actor-action b{color:#8dbdab;font-size:calc(12 * var(--tm-px, 1px));font-weight:500;letter-spacing:.08em;}body.tm-phase8-formal .tmrp-actor-action span{display:grid;grid-template-columns:auto minmax(0,1fr);gap:6px;align-items:center;min-width:0;}body.tm-phase8-formal .tmrp-actor-action em{color:#f2d98d;font-style:normal;font-size:calc(11.5 * var(--tm-px, 1px));white-space:nowrap;}body.tm-phase8-formal .tmrp-actor-action small{min-width:0;color:rgba(232,220,187,.66);font-size:calc(12 * var(--tm-px, 1px));line-height:1.45;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
      'body.tm-phase8-formal .tmrp-pcdebug{display:grid;gap:8px;}body.tm-phase8-formal .tmrp-pcdebug-section{min-width:0;}body.tm-phase8-formal .tmrp-pcdebug-list{display:grid;gap:6px;max-height:230px;overflow:auto;padding-right:2px;}body.tm-phase8-formal .tmrp-pcdebug-row{display:grid;gap:4px;border:1px solid rgba(201,168,95,.12);background:rgba(0,0,0,.16);padding:7px;min-width:0;}body.tm-phase8-formal .tmrp-pcdebug-row b{color:#f2d98d;font-size:calc(12 * var(--tm-px, 1px));font-weight:500;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-pcdebug-row span{color:rgba(232,220,187,.66);font-size:calc(12 * var(--tm-px, 1px));line-height:1.45;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-pcdebug-tags{display:flex;flex-wrap:wrap;gap:4px;min-width:0;}body.tm-phase8-formal .tmrp-pcdebug-tag{font-style:normal;border:1px solid rgba(201,168,95,.14);background:rgba(201,168,95,.05);color:#d8c27c;font-size:calc(11 * var(--tm-px, 1px));line-height:1;padding:3px 5px;max-width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-pcdebug-entry{margin:6px 0;}body.tm-phase8-formal .tmrp-pcdebug-copy{border-color:rgba(141,189,171,.22);background:rgba(141,189,171,.055);}body.tm-phase8-formal .tmrp-pcdebug-copy .tmrp-action-row{margin-top:0;}body.tm-phase8-formal .tmrp-pcdebug-copy small{color:rgba(232,220,187,.58);}',
      'body.tm-phase8-formal .tmrp-bar{display:grid;grid-template-columns:58px minmax(0,1fr) 32px;align-items:center;gap:9px;margin:9px 0;font-size:calc(11.5 * var(--tm-px, 1px));color:rgba(232,220,187,.66);}body.tm-phase8-formal .tmrp-bar i{height:7px;border-radius:4px;background:rgba(0,0,0,.34);border:1px solid rgba(201,168,95,.14);overflow:hidden;}body.tm-phase8-formal .tmrp-bar i b{display:block;height:100%;border-radius:4px;background:linear-gradient(90deg,#8dbdab,#f2d98d 60%,#c85e49);}body.tm-phase8-formal .tmrp-bar em{font-style:normal;text-align:right;color:#e7d39e;font-variant-numeric:tabular-nums;}',
      ...
      'body.tm-phase8-formal .tmrp-chaoyi-card b{display:block;color:#ffe0a0;font-size:calc(21 * var(--tm-px, 1px));letter-spacing:.18em;text-shadow:0 1px 4px rgba(0,0,0,.75);}',
      'body.tm-phase8-formal .tmrp-chaoyi-card span span{display:block;margin-top:5px;color:rgba(243,229,194,.78);font-size:calc(12 * var(--tm-px, 1px));line-height:1.55;}',
      'body.tm-phase8-formal .tmrp-chaoyi-card small{display:inline-flex;margin-top:7px;border:1px solid rgba(204,164,76,.28);background:rgba(0,0,0,.34);color:#f3d98d;padding:2px 7px;font-size:calc(12 * var(--tm-px, 1px));letter-spacing:.08em;}',
      ...
      'body.tm-phase8-formal .tmrp-ledger-head span{color:#f2d98d;font-size:calc(12 * var(--tm-px, 1px));letter-spacing:.14em;}body.tm-phase8-formal .tmrp-ledger-head small{color:rgba(232,220,187,.48);font-size:calc(11 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .tmrp-data-table{width:100%;border-collapse:collapse;margin-top:9px;font-size:calc(11.5 * var(--tm-px, 1px));color:#eadfbd;}body.tm-phase8-formal .tmrp-data-table th,body.tm-phase8-formal .tmrp-data-table td{border:1px solid rgba(201,168,95,.14);padding:6px 7px;text-align:left;vertical-align:top;}body.tm-phase8-formal .tmrp-data-table th{color:#d8c27c;background:rgba(201,168,95,.06);font-weight:400;}body.tm-phase8-formal .tmrp-data-table td:first-child{width:72px;color:rgba(232,220,187,.56);}',
      ...
      'body.tm-phase8-formal .tm-army-detail-head{display:flex;align-items:center;justify-content:space-between;margin:-2px 0 8px;padding-bottom:8px;border-bottom:1px solid rgba(201,168,95,.18);}body.tm-phase8-formal .tm-army-detail-head b{color:#f2d98d;font-size:calc(15 * var(--tm-px, 1px));letter-spacing:.16em;}body.tm-phase8-formal .tm-army-detail-head button{width:28px;height:28px;border:1px solid rgba(201,168,95,.22);background:rgba(0,0,0,.22);color:#eadfbd;cursor:pointer;}',
      ...
      'body.tm-phase8-formal .tmrp-office-node{border:1px solid rgba(201,168,95,.16);background:rgba(0,0,0,.14);margin:0 0 8px;padding:0 9px 9px;}body.tm-phase8-formal .tmrp-office-node summary{cursor:pointer;list-style:none;padding:9px 0;color:#f2d98d;font-size:calc(13 * var(--tm-px, 1px));letter-spacing:.10em;}body.tm-phase8-formal .tmrp-office-node summary::-webkit-details-marker{display:none;}body.tm-phase8-formal .tmrp-office-node summary small{float:right;color:rgba(232,220,187,.48);font-size:calc(11 * var(--tm-px, 1px));letter-spacing:.04em;}',
      'body.tm-phase8-formal .tmrp-office-pos{border:1px solid rgba(201,168,95,.12);background:rgba(255,245,210,.035);padding:8px;margin:7px 0;}body.tm-phase8-formal .tmrp-office-pos>b{display:block;color:#f2d98d;font-size:calc(13 * var(--tm-px, 1px));margin-bottom:5px;}body.tm-phase8-formal .tmrp-office-pos .tmrp-pill{margin:0 4px 5px 0;}',
      'body.tm-phase8-formal .tmrp-admin-shell{display:flex;flex-direction:column;gap:13px;color:#eadfbd;font-family:"STKaiti","KaiTi","楷体",serif;}body.tm-phase8-formal .tmrp-admin-card{box-shadow:inset 3px 0 var(--admin-c,rgba(201,168,95,.42));}body.tm-phase8-formal .tmrp-admin-title{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:8px;}body.tm-phase8-formal .tmrp-admin-title b{color:#f2d98d;font-size:calc(15 * var(--tm-px, 1px));letter-spacing:.12em;}body.tm-phase8-formal .tmrp-admin-title small{color:rgba(232,220,187,.50);font-size:calc(11 * var(--tm-px, 1px));text-align:right;line-height:1.45;}',
      'body.tm-phase8-formal .tmrp-step{border-left:2px solid rgba(198,78,55,.55);padding:5px 0 5px 8px;margin:5px 0;color:rgba(232,220,187,.68);font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.5;}body.tm-phase8-formal .tmrp-step b{color:#f2d98d;margin-right:6px;}',
      'body.tm-phase8-formal .tmrp-finance-shell{display:flex;flex-direction:column;gap:13px;color:#eadfbd;font-family:"STKaiti","KaiTi","楷体",serif;}body.tm-phase8-formal .tmrp-fin-line{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:6px;border:1px solid rgba(201,168,95,.12);background:rgba(0,0,0,.14);padding:7px;margin:6px 0;}body.tm-phase8-formal .tmrp-fin-line b{min-width:0;color:#f2d98d;font-size:calc(12 * var(--tm-px, 1px));white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}body.tm-phase8-formal .tmrp-fin-line span{color:#eadfbd;font-size:calc(12 * var(--tm-px, 1px));}body.tm-phase8-formal .tmrp-fin-line small{grid-column:1/3;color:rgba(232,220,187,.52);font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.45;}',
      'body.tm-phase8-formal .tmrp-wenshi-shell{display:flex;flex-direction:column;gap:13px;color:#eadfbd;font-family:"STKaiti","KaiTi","楷体",serif;}body.tm-phase8-formal .tmrp-work-card{display:grid;grid-template-columns:42px minmax(0,1fr);gap:9px;}body.tm-phase8-formal .tmrp-work-tab{min-height:74px;border:1px solid rgba(201,168,95,.20);background:linear-gradient(180deg,rgba(201,168,95,.12),rgba(0,0,0,.18));color:#f2d98d;display:flex;align-items:center;justify-content:center;writing-mode:vertical-rl;letter-spacing:.12em;font-size:calc(12 * var(--tm-px, 1px));}body.tm-phase8-formal .tmrp-keju-hero{background:linear-gradient(135deg,rgba(206,169,87,.18),rgba(80,40,20,.12));border-color:rgba(206,169,87,.45);}body.tm-phase8-formal .tmrp-wen-filters .tmrp-pill{cursor:pointer;font-family:inherit;letter-spacing:.04em;transition:border-color .15s,color .15s,background .15s;}body.tm-phase8-formal .tmrp-wen-filters .tmrp-pill:hover{border-color:rgba(226,185,92,.42);color:#f2d98d;}body.tm-phase8-formal .tmrp-pill.active{border-color:rgba(213,103,73,.55);background:linear-gradient(180deg,rgba(126,45,32,.6),rgba(40,20,14,.5));color:#ffe1ac;}',
      ...
      'body.tm-phase8-formal .tmrp-chip-list,body.tm-phase8-formal .tmrp-pill-row{display:flex;flex-wrap:wrap;gap:5px;}body.tm-phase8-formal .tmrp-pill{display:inline-flex;max-width:100%;border:1px solid rgba(201,168,95,.16);background:rgba(201,168,95,.06);color:#d8c27c;padding:4px 7px;font-size:calc(12 * var(--tm-px, 1px));line-height:1.25;}',
      // 社会层地基（2026-06-12）：满意趋势徽 + 议程急缓徽 + 满意/党势近账行
      'body.tm-phase8-formal .tmrp-trend{display:inline-block;margin-left:4px;font-style:normal;font-size:calc(11 * var(--tm-px, 1px));padding:0 4px;border:1px solid rgba(201,168,95,.18);border-radius:2px;}body.tm-phase8-formal .tmrp-trend.up{color:#9fd08a;}body.tm-phase8-formal .tmrp-trend.down{color:#e08585;}',
      'body.tm-phase8-formal .tmrp-pill.tmrp-agenda.u2{border-color:rgba(240,200,120,.45);color:#f2d98d;}body.tm-phase8-formal .tmrp-pill.tmrp-agenda.u3{border-color:rgba(224,133,133,.55);color:#e08585;}body.tm-phase8-formal .tmrp-pill.tmrp-agenda small{margin-left:3px;opacity:.7;font-size:calc(10.5 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .tmrp-ledger-row{display:flex;gap:7px;align-items:baseline;font-size:calc(12 * var(--tm-px, 1px));line-height:1.6;min-width:0;}body.tm-phase8-formal .tmrp-ledger-row b{font-weight:600;min-width:40px;text-align:right;flex:none;}body.tm-phase8-formal .tmrp-ledger-row b.pos{color:#9fd08a;}body.tm-phase8-formal .tmrp-ledger-row b.neg{color:#e08585;}body.tm-phase8-formal .tmrp-ledger-row small{color:rgba(232,220,187,.66);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;min-width:0;}',
      'body.tm-phase8-formal .tmrp-warning-line{margin:8px 0;padding:7px 8px;border:1px solid rgba(198,78,55,.30);background:rgba(198,78,55,.10);color:#e7b59a;font-size:calc(12 * var(--tm-px, 1px));line-height:1.55;}',
      'body.tm-phase8-formal .tmrp-log{display:grid;grid-template-columns:26px minmax(0,1fr) auto;gap:7px;align-items:start;border:1px solid rgba(201,168,95,.12);background:rgba(0,0,0,.14);padding:7px;}body.tm-phase8-formal .tmrp-log b{width:22px;height:22px;display:grid;place-items:center;border:1px solid rgba(201,168,95,.28);border-radius:50%;color:#f2d98d;font-size:calc(12 * var(--tm-px, 1px));}body.tm-phase8-formal .tmrp-log span{color:rgba(232,220,187,.70);font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.55;}body.tm-phase8-formal .tmrp-log strong{color:#f2d98d;font-weight:500;}body.tm-phase8-formal .tmrp-log em{font-style:normal;color:#8dbdab;font-size:calc(11 * var(--tm-px, 1px));white-space:nowrap;}body.tm-phase8-formal .tmrp-empty{padding:22px 16px;text-align:center;color:rgba(232,220,187,.48);font-size:calc(12 * var(--tm-px, 1px));line-height:1.75;letter-spacing:.04em;}',
      'body.tm-phase8-formal .tmrp-empty-hero{text-align:center;padding:24px 16px 18px;border:1px dashed rgba(201,168,95,.26);border-radius:3px;background:radial-gradient(140px 90px at 50% 30%,rgba(201,168,95,.06),transparent);margin-bottom:14px;}body.tm-phase8-formal .tmrp-empty-seal{width:56px;height:56px;margin:0 auto 13px;display:grid;place-items:center;border:1.5px solid rgba(201,168,95,.34);border-radius:50%;color:#d8c27c;font-size:calc(25 * var(--tm-px, 1px));font-family:"STKaiti","KaiTi","楷体",serif;background:radial-gradient(circle at 36% 26%,rgba(255,229,153,.16),rgba(30,22,12,.6));}body.tm-phase8-formal .tmrp-empty-t{color:#e7d39e;font-size:calc(14 * var(--tm-px, 1px));letter-spacing:.1em;}body.tm-phase8-formal .tmrp-empty-d{margin-top:8px;color:rgba(232,220,187,.5);font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.8;}body.tm-phase8-formal .tmrp-empty-hero .tmrp-action-row{justify-content:center;margin-top:15px;}',
      'body.tm-phase8-formal .tmrp-ghost-label{text-align:center;color:rgba(232,220,187,.42);font-size:calc(11.5 * var(--tm-px, 1px));letter-spacing:.16em;margin:2px 0 9px;}body.tm-phase8-formal .tmrp-ghost{opacity:.42;filter:grayscale(.25);pointer-events:none;display:flex;flex-direction:column;gap:8px;}'
    ].join('\n');
    document.head.appendChild(st);
  }
