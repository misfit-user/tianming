...
(function(){
  ...
  function installDeskPanelExactStyles(){
    ...
    var __css = [
      ...
      'body.tm-phase8-formal .tm-desk-head h2{margin:0;color:#f2d98d;font-size:calc(22 * var(--tm-px, 1px));letter-spacing:.20em;font-weight:500;}',
      'body.tm-phase8-formal .tm-desk-head p{margin:4px 0 0;color:rgba(232,220,187,.55);font-size:calc(12 * var(--tm-px, 1px));letter-spacing:.08em;}',
      ...
      'body.tm-phase8-formal .tm-desk-item b{display:block;color:#f2d98d;font-size:calc(14 * var(--tm-px, 1px));letter-spacing:.08em;}',
      'body.tm-phase8-formal .tm-desk-item span{display:block;margin-top:4px;color:rgba(232,220,187,.55);font-size:calc(12 * var(--tm-px, 1px));line-height:1.45;}',
      'body.tm-phase8-formal .tm-desk-item.hot{border-color:rgba(198,78,55,.38);box-shadow:inset 3px 0 rgba(198,78,55,.36);}',
      'body.tm-phase8-formal .tm-desk-title{margin:0 0 10px;color:#f2d98d;font-size:calc(18 * var(--tm-px, 1px));letter-spacing:.14em;}',
      'body.tm-phase8-formal .tm-desk-subtitle{margin:12px 0 7px;color:#d8bd76;font-size:calc(13 * var(--tm-px, 1px));letter-spacing:.12em;}',
      'body.tm-phase8-formal .tm-desk-field{display:grid;grid-template-columns:76px minmax(0,1fr);gap:8px;align-items:center;margin-bottom:8px;color:rgba(232,220,187,.68);font-size:calc(12 * var(--tm-px, 1px));}',
      ...
      'body.tm-phase8-formal .tm-desk-stat span{display:block;color:rgba(232,220,187,.52);font-size:calc(12 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .tm-desk-stat b{display:block;color:#f2d98d;font-size:calc(15 * var(--tm-px, 1px));margin-top:3px;}',
      'body.tm-phase8-formal .tm-desk-row{display:grid;grid-template-columns:88px minmax(0,1fr);gap:8px;padding:7px 0;border-bottom:1px solid rgba(201,160,69,.10);font-size:calc(12 * var(--tm-px, 1px));}',
      ...
      'body.tm-phase8-formal .tm-desk-card b{display:block;color:#f2d98d;font-size:calc(13 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .tm-desk-card p{margin:6px 0 0;color:rgba(232,220,187,.68);font-size:calc(12 * var(--tm-px, 1px));line-height:1.6;}',
      'body.tm-phase8-formal .tm-desk-table{width:100%;border-collapse:collapse;font-size:calc(12 * var(--tm-px, 1px));}',
      ...
      'body.tm-phase8-formal .tm-desk-empty{padding:14px;color:rgba(232,220,187,.55);font-size:calc(12 * var(--tm-px, 1px));line-height:1.7;}',
  ...
  function installActionPanelExactStyles(){
    ...
    var __css = [
      ...
      'body.tm-phase8-formal .tm-chip{display:inline-flex;align-items:center;justify-content:center;min-height:18px;padding:1px 7px;border:1px solid rgba(201,160,69,.18);border-radius:999px;color:rgba(240,226,184,.78);background:rgba(255,245,210,.045);font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.2;white-space:nowrap;}',
      ...
      'body.tm-phase8-formal .tm-mini-btn,body.tm-phase8-formal .tm-action-primary,body.tm-phase8-formal .tm-action-ghost{min-height:28px;border:1px solid rgba(201,160,69,.22);color:#eadfbd;background:rgba(0,0,0,.22);cursor:pointer;font-family:inherit;font-size:calc(12 * var(--tm-px, 1px));padding:4px 10px;}',
      ...
      'body.tm-phase8-formal .tm-input,body.tm-phase8-formal .tm-select,body.tm-phase8-formal .tm-textarea{box-sizing:border-box;width:100%;border:1px solid rgba(201,160,69,.22);background:rgba(0,0,0,.20);color:#eadfbd;font-family:inherit;font-size:calc(12 * var(--tm-px, 1px));padding:7px 8px;}',
      ...
      'body.tm-phase8-formal .tm-stat span{display:block;color:rgba(232,220,187,.50);font-size:calc(11.5 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .tm-stat b{display:block;margin-top:3px;color:#f2ddb0;font-size:calc(15 * var(--tm-px, 1px));}',
      ...
      'body.tm-phase8-formal .edict-old-sug-title,body.tm-phase8-formal .edict-old-section-title{display:flex;align-items:center;justify-content:space-between;gap:8px;margin:0;color:#f0d68d;font-family:"STKaiti","KaiTi",serif;font-size:calc(14 * var(--tm-px, 1px));letter-spacing:.18em;}',
      ...
      'body.tm-phase8-formal .edict-old-sug-item b{display:block;color:#f0d892;font-size:calc(12 * var(--tm-px, 1px));} body.tm-phase8-formal .edict-old-sug-item p{margin:5px 0 7px;color:rgba(236,226,193,.76);font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.48;}',
      ...
      'body.tm-phase8-formal .edict-old-seal{width:50px;height:50px;display:grid;place-items:center;border:1px solid rgba(213,176,95,.48);border-radius:50%;color:#f2d98d;background:radial-gradient(circle,rgba(201,160,69,.20),rgba(64,31,20,.80) 72%);font-size:calc(18 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .edict-old-title strong{display:block;color:#f5dc96;font-size:calc(22 * var(--tm-px, 1px));letter-spacing:.22em;} body.tm-phase8-formal .edict-old-title span{display:block;margin-top:4px;color:rgba(232,218,178,.64);font-size:calc(12 * var(--tm-px, 1px));letter-spacing:.14em;}',
      ...
      'body.tm-phase8-formal .edict-old-card-head b{display:block;color:#f0d892;font-size:calc(13 * var(--tm-px, 1px));} body.tm-phase8-formal .edict-old-card-head span span{display:block;margin-top:3px;color:rgba(224,211,171,.56);font-size:calc(11.5 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .edict-old-forecast{margin-top:7px;color:rgba(232,220,187,.62);font-size:calc(12 * var(--tm-px, 1px));line-height:1.45;}',
      ...
      'body.tm-phase8-formal .edict-xingzhi-head b{display:block;color:#f0d892;font-size:calc(13 * var(--tm-px, 1px));} body.tm-phase8-formal .edict-xingzhi-head span{display:block;margin:4px 0 8px;color:rgba(232,220,187,.58);font-size:calc(12 * var(--tm-px, 1px));}',
      ...
      'body.tm-phase8-formal .edict-sug-portrait-wrap{width:42px;height:52px;display:grid;place-items:center;position:relative;overflow:hidden;border:1px solid rgba(201,160,69,.22);background:radial-gradient(circle at 50% 28%,rgba(201,160,69,.20),rgba(0,0,0,.26));color:#efd990;font-size:calc(18 * var(--tm-px, 1px));}',
      ...
      'body.tm-phase8-formal .edict-sug-v2 b{display:block;color:#f0d892;font-size:calc(12 * var(--tm-px, 1px));} body.tm-phase8-formal .edict-sug-v2 p{margin:5px 0 7px;color:rgba(236,226,193,.76);font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.48;}',
      'body.tm-phase8-formal .edict-sug-footer{display:flex;align-items:center;justify-content:space-between;gap:8px;} body.tm-phase8-formal .edict-sug-adopt{min-height:24px;padding:2px 9px;border:1px solid rgba(213,92,64,.34);color:#fff0c9;background:linear-gradient(180deg,#7f3528,#331612);font-family:inherit;font-size:calc(12 * var(--tm-px, 1px));cursor:pointer;}',
      'body.tm-phase8-formal .edict-sug-delete{margin-left:5px;min-width:24px;min-height:24px;border:1px solid rgba(201,160,69,.18);color:rgba(232,220,187,.58);background:rgba(0,0,0,.20);font-family:inherit;font-size:calc(14 * var(--tm-px, 1px));line-height:1;cursor:pointer;} body.tm-phase8-formal .edict-sug-delete:hover{color:#f0a082;border-color:rgba(213,92,64,.40);}',
      'body.tm-phase8-formal .edict-old-label{display:block;margin-bottom:4px;color:rgba(224,211,171,.62);font-size:calc(11.5 * var(--tm-px, 1px));letter-spacing:.12em;}',
      ...
      'body.tm-phase8-formal .edict-polish-title{position:absolute;right:18px;top:16px;writing-mode:vertical-rl;color:#f0d892;letter-spacing:.35em;font-size:calc(18 * var(--tm-px, 1px));} body.tm-phase8-formal .edict-polish-text{width:100%;min-height:130px;border:0;background:transparent;color:#f5e9c6;font-family:"STKaiti","KaiTi",serif;font-size:calc(14 * var(--tm-px, 1px));line-height:1.85;resize:vertical;}',
      'body.tm-phase8-formal .edict-polish-actions{display:flex;gap:7px;margin-top:8px;} body.tm-phase8-formal .edict-polish-seal{position:absolute;right:30px;bottom:18px;width:44px;height:44px;display:grid;place-items:center;border:1px solid rgba(213,92,64,.50);border-radius:50%;color:#d66a50;font-size:calc(11 * var(--tm-px, 1px));opacity:.82;}',
      'body.tm-phase8-formal .edict-xingzhi-row{display:grid;grid-template-columns:72px minmax(0,1fr);gap:8px;padding:5px 0;border-top:1px solid rgba(201,160,69,.12);font-size:calc(11.5 * var(--tm-px, 1px));}',
      ...
      'body.tm-phase8-formal .tm-panel-v4-title .seal{width:40px;height:40px;display:grid;place-items:center;border:1px solid rgba(211,169,82,.38);color:#f1d98d;background:radial-gradient(circle,rgba(152,45,31,.34),rgba(24,13,8,.92) 70%);font-size:calc(20 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .tm-panel-v4-title b{display:block;color:#f2d990;font-size:calc(19 * var(--tm-px, 1px));letter-spacing:.10em;} body.tm-phase8-formal .tm-panel-v4-title span:not(.seal){display:block;margin-top:4px;color:rgba(232,217,176,.56);font-size:calc(12 * var(--tm-px, 1px));}',
      ...
      'body.tm-phase8-formal .memorial-filter-v4 i{width:24px;height:24px;display:grid;place-items:center;border-radius:50%;border:1px solid rgba(201,160,69,.24);color:#f0d892;font-style:normal;font-size:calc(12 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .memorial-filter-v4 b,body.tm-phase8-formal .hy-person-v4 b,body.tm-phase8-formal .records-tab-v4 b{display:block;color:#f0d892;font-size:calc(12 * var(--tm-px, 1px));white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
      'body.tm-phase8-formal .memorial-filter-v4 span,body.tm-phase8-formal .hy-person-v4 span,body.tm-phase8-formal .records-tab-v4 span{display:block;margin-top:3px;color:rgba(224,211,171,.54);font-size:calc(11 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .memorial-side-note{margin-top:12px;padding:10px;border:1px solid rgba(201,160,69,.14);background:rgba(0,0,0,.18);} body.tm-phase8-formal .memorial-side-note b{display:block;margin-bottom:5px;color:#f0d892;font-size:calc(12 * var(--tm-px, 1px));} body.tm-phase8-formal .memorial-side-note p{margin:0;color:rgba(232,220,187,.66);font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.55;}',
      ...
      'body.tm-phase8-formal .memorial-paper-head-v4,body.tm-phase8-formal .records-paper-head-v4{display:flex;align-items:flex-start;justify-content:space-between;gap:14px;padding-bottom:12px;margin-bottom:12px;border-bottom:1px solid rgba(201,160,69,.20);} body.tm-phase8-formal .memorial-paper-head-v4 h2,body.tm-phase8-formal .records-paper-head-v4 h2{margin:0;color:#f1d98d;font-size:calc(26 * var(--tm-px, 1px));letter-spacing:.08em;} body.tm-phase8-formal .memorial-paper-head-v4 p,body.tm-phase8-formal .records-paper-head-v4 p{margin:4px 0 0;color:rgba(232,220,187,.58);font-size:calc(12 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .memorial-group-v4{margin-top:14px;} body.tm-phase8-formal .memorial-group-title-v4,body.tm-phase8-formal .records-section-title-v4{display:flex;align-items:center;justify-content:space-between;margin:0 0 8px;color:#efd58b;font-size:calc(18 * var(--tm-px, 1px));letter-spacing:.08em;}',
      ...
      'body.tm-phase8-formal .memorial-card-head-v4{display:grid;grid-template-columns:46px minmax(0,1fr) auto;gap:10px;align-items:center;} body.tm-phase8-formal .memorial-avatar-v4{width:42px;height:42px;display:grid;place-items:center;border:1px solid rgba(201,160,69,.35);border-radius:50%;color:#f6e5ad;background:radial-gradient(circle,rgba(201,160,69,.28),rgba(38,21,13,.95) 70%);font-size:calc(18 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .memorial-card-head-v4 b,body.tm-phase8-formal .records-card-v4 b,body.tm-phase8-formal .bn-affair-v4 b{display:block;color:#f1d98d;font-size:calc(13 * var(--tm-px, 1px));} body.tm-phase8-formal .memorial-card-head-v4 span,body.tm-phase8-formal .records-card-v4 p,body.tm-phase8-formal .bn-affair-v4 p{color:rgba(232,220,187,.70);font-size:calc(12 * var(--tm-px, 1px));line-height:1.55;}',
      'body.tm-phase8-formal .memorial-body-v4{margin:10px 0 9px;padding:10px 12px;color:rgba(242,231,202,.82);background:linear-gradient(180deg,rgba(255,245,210,.045),rgba(0,0,0,.10));border-top:1px solid rgba(201,160,69,.13);border-bottom:1px solid rgba(201,160,69,.10);font-size:calc(13 * var(--tm-px, 1px));line-height:1.65;}',
      ...
      'body.tm-phase8-formal .hy-route-v4{margin-bottom:10px;padding:9px 10px;border:1px solid rgba(198,139,69,.24);color:#eadbb4;background:linear-gradient(90deg,rgba(95,44,27,.40),rgba(0,0,0,.12));font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.45;}',
      'body.tm-phase8-formal .hy-region-v4{margin:10px 0 5px;color:rgba(240,214,141,.82);font-size:calc(11.5 * var(--tm-px, 1px));letter-spacing:.14em;} body.tm-phase8-formal .hy-person-v4{display:grid;grid-template-columns:30px minmax(0,1fr) auto;gap:8px;align-items:center;min-height:45px;padding:7px 8px;margin-bottom:6px;} body.tm-phase8-formal .hy-face-v4{width:28px;height:28px;display:grid;place-items:center;border:1px solid rgba(126,184,167,.30);border-radius:50%;color:#d7f0df;background:radial-gradient(circle,rgba(126,184,167,.22),rgba(13,24,22,.92));}',
      ...
      'body.tm-phase8-formal .hy-contact-head-v4 .portrait{width:50px;height:50px;display:grid;place-items:center;border:1px solid rgba(126,184,167,.36);color:#e8f6df;background:radial-gradient(circle,rgba(126,184,167,.28),rgba(11,19,18,.92));font-size:calc(22 * var(--tm-px, 1px));} body.tm-phase8-formal .hy-contact-head-v4 b{color:#f0d892;font-size:calc(15 * var(--tm-px, 1px));} body.tm-phase8-formal .hy-contact-head-v4 span{display:block;margin-top:4px;color:rgba(224,211,171,.58);font-size:calc(12 * var(--tm-px, 1px));}',
      'body.tm-phase8-formal .hy-message-v4{margin-bottom:9px;padding:10px 11px;border:1px solid rgba(126,184,167,.16);background:rgba(255,245,210,.045);} body.tm-phase8-formal .hy-message-v4.out{margin-left:46px;border-right:2px solid rgba(126,184,167,.55);} body.tm-phase8-formal .hy-message-v4.in{margin-right:46px;border-left:2px solid rgba(213,92,64,.52);} body.tm-phase8-formal .hy-message-v4 b{display:block;color:#f0d892;font-size:calc(12 * var(--tm-px, 1px));} body.tm-phase8-formal .hy-message-v4 p{margin:7px 0;color:rgba(238,228,197,.78);font-size:calc(12.5 * var(--tm-px, 1px));line-height:1.58;}',
      ...
      'body.tm-phase8-formal .hy-filterbar-v4{display:flex;flex-wrap:wrap;gap:6px;margin:0 0 10px;} body.tm-phase8-formal .hy-filterbar-v4 button{min-height:26px;padding:3px 9px;border:1px solid rgba(126,184,167,.18);color:#d9eddf;background:rgba(255,245,210,.035);font-family:inherit;font-size:calc(12 * var(--tm-px, 1px));cursor:pointer;} body.tm-phase8-formal .hy-filterbar-v4 button.active{border-color:rgba(126,184,167,.42);background:linear-gradient(180deg,rgba(58,104,86,.44),rgba(13,24,22,.66));}',
      'body.tm-phase8-formal .hy-intercept-v4{margin-top:12px;padding-top:10px;border-top:1px solid rgba(126,184,167,.18);}',
      'body.tm-phase8-formal .hy-compose-v4 label{display:block;margin-bottom:8px;} body.tm-phase8-formal .hy-compose-v4 label span{display:block;margin-bottom:4px;color:rgba(224,211,171,.58);font-size:calc(11.5 * var(--tm-px, 1px));}',
      ...
      'body.tm-phase8-formal .hy-multi-hint-v5{flex:1;min-width:96px;font-size:calc(11 * var(--tm-px, 1px));line-height:1.45;color:rgba(232,220,187,.52);}',
      ...
      'body.tm-phase8-formal .hy-person-counts-v5 em.msel{font-style:normal;font-size:calc(15 * var(--tm-px, 1px));line-height:1;color:rgba(232,220,187,.40);} body.tm-phase8-formal .hy-person-counts-v5 em.msel.on{color:#f2d98d;}',
      'body.tm-phase8-formal .hy-multi-banner-v5{margin:0 0 10px;padding:8px 10px;border:1px solid rgba(239,201,116,.35);background:rgba(120,90,30,.18);color:#eadfbd;font-size:calc(12 * var(--tm-px, 1px));line-height:1.5;} body.tm-phase8-formal .hy-multi-banner-v5 b{color:#f2d98d;margin-right:4px;} body.tm-phase8-formal .hy-multi-banner-v5 small{display:block;margin-top:3px;font-size:calc(11.5 * var(--tm-px, 1px));color:rgba(232,220,187,.55);}',
      'body.tm-phase8-formal .hy-face-v5{width:46px;height:54px;object-fit:cover;border:1px solid rgba(126,184,167,.32);background:rgba(0,0,0,.28);box-shadow:0 5px 12px rgba(0,0,0,.24);} body.tm-phase8-formal .hy-person-main-v5{min-width:0;} body.tm-phase8-formal .hy-person-main-v5 b{display:block;color:#f0d892;font-size:calc(13 * var(--tm-px, 1px));white-space:normal;overflow:visible;text-overflow:clip;line-height:1.35;} body.tm-phase8-formal .hy-person-main-v5 span,body.tm-phase8-formal .hy-person-main-v5 i{display:block;margin-top:3px;color:rgba(232,220,187,.58);font-size:calc(11.5 * var(--tm-px, 1px));white-space:normal;overflow:visible;text-overflow:clip;font-style:normal;line-height:1.35;}',
      'body.tm-phase8-formal .hy-person-counts-v5{display:flex;flex-direction:column;gap:4px;align-items:flex-end;} body.tm-phase8-formal .hy-person-counts-v5 em{min-width:20px;height:18px;display:grid;place-items:center;border:1px solid rgba(126,184,167,.24);border-radius:999px;color:#d9eddf;background:rgba(0,0,0,.18);font-size:calc(11 * var(--tm-px, 1px));font-style:normal;} body.tm-phase8-formal .hy-person-counts-v5 em.hot{border-color:rgba(213,92,64,.38);color:#f0a082;background:rgba(126,31,24,.18);} body.tm-phase8-formal .hy-person-counts-v5 em.on{border-color:rgba(239,201,116,.42);color:#f5db96;}',
...
+ '.ed-yuan .head-center .hc-main{position:relative;z-index:1;font-size:calc(25 * var(--tm-px, 1px));font-weight:bold;color:var(--ink);letter-spacing:0.18em;line-height:1.05;text-shadow:0 1px 0 rgba(255,255,255,0.7),0 -1px 0 rgba(120,90,36,0.3),0 2px 4px rgba(120,90,36,0.28),0 0 16px rgba(216,185,106,0.26);}'
...
+ '.ed-yuan .head-center .hc-sub{font-size:calc(12 * var(--tm-px, 1px));color:var(--ink-faint);letter-spacing:0.32em;margin-top:3px;}'
...
+ '.ed-yuan .ed-tab{font-family:var(--font);font-size:calc(13 * var(--tm-px, 1px));letter-spacing:0.1em;color:var(--ink-soft);cursor:pointer;padding:7px 15px;transition:all .15s;border:0;background:transparent;}'
...
+ '.ed-yuan .link-btn{font-family:var(--font);font-size:calc(12.5 * var(--tm-px, 1px));letter-spacing:0.06em;cursor:pointer;padding:7px 13px;border-radius:5px;border:1px solid var(--gold-d);background:#fbf4e2;color:var(--gold-d);transition:all .15s;display:inline-flex;align-items:center;gap:6px;box-shadow:0 1px 3px rgba(80,56,24,0.12);}'
...
+ '.ed-yuan .col-sug-t{flex:0 0 auto;position:relative;z-index:1;font-size:calc(15 * var(--tm-px, 1px));color:var(--cinnabar-d);letter-spacing:0.18em;font-weight:bold;margin-bottom:9px;}'
+ '.ed-yuan .col-sug-t small{font-size:calc(12 * var(--tm-px, 1px));color:var(--ink-faint);letter-spacing:0.04em;font-weight:normal;margin-left:6px;}'
...
+ '.ed-yuan .edict-sug-v2 b{display:block;color:var(--jade);font-size:calc(12 * var(--tm-px, 1px));letter-spacing:0.08em;margin-bottom:3px;font-weight:normal;}'
+ '.ed-yuan .edict-sug-v2 p{margin:0 0 4px;color:var(--ink-soft);font-size:calc(12 * var(--tm-px, 1px));line-height:1.55;}'
+ '.ed-yuan .edict-sug-footer{display:flex;align-items:center;justify-content:space-between;gap:7px;margin-top:7px;}'
+ '.ed-yuan .edict-sug-adopt{flex:1;position:relative;overflow:hidden;font-family:var(--font);font-size:calc(12.5 * var(--tm-px, 1px));letter-spacing:0.2em;cursor:pointer;padding:6px 10px;border-radius:3px;color:#fff;border:1px solid var(--gold-d);background:linear-gradient(160deg,var(--cinnabar-hi),var(--cinnabar) 55%,var(--cinnabar-d));box-shadow:inset 0 1px 0 rgba(255,255,255,0.22),inset 0 0 0 1px rgba(216,185,106,0.32),0 2px 5px rgba(122,32,24,0.32);}'
...
+ '.ed-yuan .edict-sug-delete{flex:0 0 auto;width:26px;height:26px;cursor:pointer;font-family:var(--font);font-size:calc(15 * var(--tm-px, 1px));line-height:1;border:1px solid rgba(140,124,96,0.5);background:transparent;color:var(--ink-faint);border-radius:4px;transition:all .15s;}'
+ '.ed-yuan .edict-sug-delete:hover{border-color:var(--cinnabar);color:var(--cinnabar);background:rgba(168,50,40,0.08);}'
+ '.ed-yuan .tm-chip{display:inline-flex;align-items:center;min-height:18px;padding:1px 7px;border:1px solid rgba(85,127,111,0.4);border-radius:999px;color:var(--jade);background:transparent;font-size:calc(11.5 * var(--tm-px, 1px));}'
...
+ '.ed-yuan .edict-prom-card .epc-seal{width:26px;height:26px;flex:0 0 auto;display:grid;place-items:center;border-radius:5px;font-size:calc(14 * var(--tm-px, 1px));font-weight:bold;color:#fff;background:linear-gradient(150deg,#c64a3e,#7a2018);box-shadow:0 1px 4px rgba(122,32,24,0.4);}'
+ '.ed-yuan .edict-prom-card .epc-hd b{font-size:calc(14.5 * var(--tm-px, 1px));letter-spacing:0.1em;color:#7a2018;}'
+ '.ed-yuan .edict-prom-card .epc-hd em{font-style:normal;font-size:calc(11.5 * var(--tm-px, 1px));color:#9c8b6b;letter-spacing:0.02em;margin-left:auto;}'
...
+ '.ed-yuan .edict-prom-card .epc-btn{font-family:inherit;font-size:calc(12 * var(--tm-px, 1px));letter-spacing:0.04em;cursor:pointer;padding:5px 14px;border-radius:6px;border:1px solid rgba(168,131,58,0.4);background:rgba(255,252,243,0.6);color:#574733;transition:all .14s;}'
+ '.ed-yuan .edict-prom-card .epc-btn:hover{background:#fffdf6;border-color:#a8833a;color:#241d15;}'
+ '.ed-yuan .edict-prom-card .epc-note{font-size:calc(11 * var(--tm-px, 1px));color:#9c8b6b;letter-spacing:0.02em;}'
...
+ '.ed-yuan .seal-hint{font-size:calc(10.5 * var(--tm-px, 1px));line-height:1.3;color:var(--ink-soft);text-align:center;opacity:1;transition:color .2s,opacity .2s;}'
...
+ '.ed-yuan .cell-seal .cs-1{position:absolute;top:6px;left:7px;font-size:calc(23 * var(--tm-px, 1px));line-height:1;color:var(--sc,var(--gold-d));font-weight:bold;text-shadow:0 1px 0 rgba(255,255,255,0.5);}'
+ '.ed-yuan .cell-seal .cs-2{position:absolute;bottom:6px;right:7px;font-size:calc(13 * var(--tm-px, 1px));line-height:1;color:var(--sc,var(--gold-d));font-weight:bold;opacity:0.92;}'
...
+ '.ed-yuan .ed-forecast{flex:0 0 auto;position:relative;font-size:calc(11.5 * var(--tm-px, 1px));line-height:1.45;color:#3c6053;letter-spacing:0.02em;padding:3px 6px 0 16px;}'
+ '.ed-yuan .ed-forecast::before{content:"批";position:absolute;left:0;top:3px;font-size:calc(10 * var(--tm-px, 1px));color:var(--cinnabar);border:1px solid var(--cinnabar);border-radius:2px;padding:0 1px;line-height:1.3;opacity:0.78;transform:rotate(-6deg);}'
+ '.ed-yuan .ed-polish-bar{flex:0 0 auto;display:flex;align-items:center;gap:10px;margin:8px 2px 6px;}'
+ '.ed-yuan .ed-polish-bar .lbl{font-size:calc(12.5 * var(--tm-px, 1px));color:var(--ink-soft);letter-spacing:0.14em;}'
+ '.ed-yuan .ed-polish-bar select{appearance:none;-webkit-appearance:none;font-family:var(--font);font-size:calc(12.5 * var(--tm-px, 1px));padding:6px 28px 6px 12px;color:var(--ink);border:1px solid var(--gold-d);border-radius:5px;cursor:pointer;background:linear-gradient(180deg,#fffdf3,#f6edd6),url("data:image/svg+xml,%3Csvg xmlns=\'' + _edictYuanSvgNs() + '\' width=\'10\' height=\'7\'%3E%3Cpath d=\'M1 1l4 4 4-4\' fill=\'none\' stroke=\'%237d5e22\' stroke-width=\'1.6\' stroke-linecap=\'round\'/%3E%3C/svg%3E") no-repeat;background-position:0 0,right 10px center;box-shadow:inset 0 1px 0 rgba(255,255,255,0.6);}'
...
+ '.ed-yuan .xinglu-main .xm-title{font-size:calc(17 * var(--tm-px, 1px));color:var(--ink);letter-spacing:0.18em;}'
+ '.ed-yuan .xinglu-main .xm-desc{font-size:calc(12 * var(--tm-px, 1px));color:var(--ink-faint);}'
+ '.ed-yuan .x-field{flex:1;min-height:0;width:100%;font-family:var(--font);font-size:calc(15 * var(--tm-px, 1px));line-height:2;color:var(--ink);background:repeating-linear-gradient(180deg,transparent 0 33px,rgba(120,90,36,0.08) 33px 34px);background-position:0 6px;border:none;border-radius:2px;padding:4px 8px;resize:none;outline:none;overflow-y:auto;scrollbar-width:none;}'
...
+ '.ed-yuan .xinglu-hist .xh-t{flex:0 0 auto;font-size:calc(14 * var(--tm-px, 1px));color:var(--gold-d);letter-spacing:0.16em;margin-bottom:8px;}'
+ '.ed-yuan .xinglu-hist .xh-list{flex:1;min-height:0;overflow-y:auto;scrollbar-width:thin;}'
+ '.ed-yuan .x-hist-item{font-size:calc(13 * var(--tm-px, 1px));color:var(--ink-soft);padding:8px 0;border-bottom:1px dotted rgba(140,124,96,0.35);line-height:1.7;}'
+ '.ed-yuan .x-hist-item .t{color:var(--cinnabar);margin-right:8px;font-size:calc(12 * var(--tm-px, 1px));}'
...
+ '.ed-yuan .arc-card-hd{flex:0 0 auto;display:flex;align-items:center;justify-content:space-between;padding:14px 22px 12px;border-bottom:1px solid rgba(168,131,58,0.3);font-size:calc(18 * var(--tm-px, 1px));color:var(--ink);letter-spacing:0.22em;}'
+ '.ed-yuan .arc-card-hd .ah-l{display:flex;align-items:center;gap:11px;}'
+ '.ed-yuan .arc-card-hd .ah-seal{width:28px;height:28px;display:flex;align-items:center;justify-content:center;background:linear-gradient(145deg,var(--cinnabar-hi),var(--cinnabar-d));color:#fff;font-size:calc(15 * var(--tm-px, 1px));border-radius:4px;}'
+ '.ed-yuan .arc-x{cursor:pointer;color:var(--ink-faint);font-size:calc(22 * var(--tm-px, 1px));line-height:1;width:32px;height:32px;display:flex;align-items:center;justify-content:center;border-radius:50%;transition:all .15s;}'
...
+ '.ed-yuan .arc-turn{font-size:calc(13.5 * var(--tm-px, 1px));color:var(--cinnabar-d);letter-spacing:0.1em;margin:13px 0 8px;font-weight:bold;}'
+ '.ed-yuan .arc-turn:first-child{margin-top:0;}'
+ '.ed-yuan .arc-item{position:relative;font-size:calc(13.5 * var(--tm-px, 1px));line-height:1.65;color:var(--ink-soft);padding:8px 10px 8px 18px;margin-left:6px;border-left:1px solid rgba(168,131,58,0.25);}'
...
+ '.ed-yuan .arc-item .a-cat{color:var(--ink-faint);font-size:calc(12 * var(--tm-px, 1px));letter-spacing:0.08em;}'
+ '.ed-yuan .arc-item .a-mark{margin-right:5px;}'
+ '.ed-yuan .arc-item .a-assignee{color:var(--jade);font-size:calc(12 * var(--tm-px, 1px));}'
+ '.ed-yuan .arc-item .a-fb{color:var(--ink-faint);font-size:calc(12.5 * var(--tm-px, 1px));font-style:italic;margin-top:4px;padding-left:4px;}'
...
+ '.ed-yuan .ed-polish-card.loading{min-height:150px;align-items:center;justify-content:center;color:var(--ink-soft);font-size:calc(15 * var(--tm-px, 1px));letter-spacing:0.08em;}'
...
+ '.ed-yuan .ed-scroll-title{position:absolute;right:18px;top:16px;writing-mode:vertical-rl;color:#7d5e22;letter-spacing:0.35em;font-size:calc(18 * var(--tm-px, 1px));text-shadow:0 1px 0 rgba(255,255,255,0.6);}'
+ '.ed-yuan .ed-scroll-text{width:100%;min-height:150px;border:1px solid rgba(168,131,58,0.25);border-radius:4px;background:linear-gradient(180deg,rgba(255,255,255,0.55),rgba(246,239,218,0.45));color:#241d15;font-family:"STKaiti","KaiTi","楷体",serif;font-size:calc(15 * var(--tm-px, 1px));line-height:2;padding:12px 14px;resize:vertical;box-shadow:inset 0 1px 0 rgba(255,255,255,0.5);text-indent:2em;}'
+ '.ed-yuan .ed-scroll-text:focus{outline:none;background:rgba(255,255,255,0.6);}'
+ '.ed-yuan .ed-scroll-seal{position:absolute;right:26px;bottom:54px;width:46px;height:46px;display:grid;place-items:center;align-content:center;border-radius:5px;border:1px solid rgba(168,50,40,0.55);color:#fff5ec;font-size:calc(12 * var(--tm-px, 1px));line-height:1.2;text-align:center;background:radial-gradient(circle at 36% 28%,var(--cinnabar-hi),var(--cinnabar) 58%,var(--cinnabar-d));box-shadow:inset 0 1px 0 rgba(255,255,255,0.3),0 2px 6px rgba(90,16,10,0.4);}'
+ '.ed-yuan .ed-scroll-seal .main{font-size:calc(13 * var(--tm-px, 1px));font-weight:bold;letter-spacing:0.06em;}'
+ '.ed-yuan .ed-scroll-actions{flex:0 0 auto;display:flex;flex-wrap:wrap;gap:8px;margin-top:10px;}'
+ '.ed-yuan .ed-scroll-btn{font-family:"STKaiti","KaiTi","楷体",serif;font-size:calc(13 * var(--tm-px, 1px));letter-spacing:0.12em;cursor:pointer;padding:7px 15px;border-radius:5px;border:1px solid var(--gold-d);background:#fbf4e2;color:var(--gold-d);transition:all .15s;}'
...
+ 'body.tm-phase8-formal .ed-yuan .edict-sug-adopt{min-height:30px !important;padding:6px 14px !important;color:#fff8e6 !important;border:1px solid #7d5e22 !important;border-radius:4px !important;font-size:calc(12.5 * var(--tm-px, 1px)) !important;letter-spacing:0.18em;background:linear-gradient(160deg,#c64a3e,#a83228 55%,#7a2018) !important;box-shadow:inset 0 1px 0 rgba(255,255,255,0.22),inset 0 0 0 1px rgba(216,185,106,0.32),0 2px 5px rgba(122,32,24,0.3) !important;cursor:pointer;}'
...
+ 'body.tm-phase8-formal .ed-yuan .edict-sug-delete{min-width:28px !important;min-height:28px !important;color:#9c8b6b !important;border:1px solid rgba(140,124,96,0.5) !important;border-radius:4px !important;background:transparent !important;font-size:calc(15 * var(--tm-px, 1px)) !important;cursor:pointer;}'
