...
const r=spawnSync(path.join(root,'node_modules/electron/dist/electron.exe'),[path.join(root,'docs/chongzhen-prefecture-map-20260917/verify-native-ui.mjs')],{cwd:root,env,stdio:['ignore',out,err],timeout:210000,windowsHide:true});
