...
| 三 | 晚唐：删死字段；格式归一；修挂错的人、补缺位长官；清理批量虚构人物 | 进行中：第一刀字段清理与格式归一（死字段 70423→0，真源 60.7M→51.5M 字符，道长官官称入正规字段；税目表按名字引用的字段改判为活）；第二刀唐廷与河朔四镇道内各州按天宝户重分户口（道与全国合计不变，开局账按财政引擎重算）；第三刀府州官守、治所与土贡物产，仪州改回辽州；第四刀之一人物字段去伪（删去抄件与制作用语，personalGoals 改为引擎对象），见 [晚唐方案](晚唐方案.md) |
