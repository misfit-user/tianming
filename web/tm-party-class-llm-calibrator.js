...
(function(global) {
  ...
  function buildSnapshot(root, options) {
    ...
    return {
      ...
      fiscalNote: (global.FiscalEngine && typeof global.FiscalEngine.readFiscalContext === 'function') ? global.FiscalEngine.readFiscalContext({game:source}) : undefined,
