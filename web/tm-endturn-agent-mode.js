...
(function (root) {
  ...
  function _buildSystemPrompt() {
    var _sysP = [
      ...
      '· 战斗必须用 resolve_battle 登记真实双方军队和唯一battleId。御驾亲征开启时，战果待玩家裁决，勿提前断言胜负；同场的伤亡、占领、主将命运全部装入battleResult，勿再用command_army/change_region_owner重复写。普通行军/疾病/逃亡损耗仍用command_army，不能凭空制造接战。',
