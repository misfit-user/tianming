...
const r=spawnSync(path.join(root,'node_modules/electron/dist/electron.exe'),[path.join(root,'docs/chongzhen-map-r2-20260918/verify-native-ui.mjs')],{cwd:root,env,stdio:['ignore',out,err],timeout:210000,windowsHide:true});
